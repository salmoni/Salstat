...
def getLeftBitmap():
    return BitmapFromImage(getgetLeftBitmapImage())
...
def getRightBitmap():
    return BitmapFromImage(getgetRightBitmapImage())
...
def getHomeBitmap():
    return BitmapFromImage(getgetHomeBitmapImage())
...
def getMainBitmap():
    return BitmapFromImage(getMainImage())
...
def getAboutBitmap():
    return BitmapFromImage(getAboutBitmapImage())
...
def getApplyBitmap():
    return BitmapFromImage(getApplyImage())
...
def getPreferencesBitmap():
    return BitmapFromImage(getPreferencesImage())
